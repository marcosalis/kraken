 ...
 *
 * In order to use this class you must create a subclass of it and declare it in the manifest like
 * this:
 *
 * <code><pre>
 *     &#60;application
...
public class DroidApplication extends Application {
    ...
    /**
     * Flag indicating whether the application package is currently built with the "debuggable"
     * attribute set to true.
     *
     * Do NOT rely on this yet, as it's still incorrect due to an issue in ADT (v22).
     */
    ...
    /**
     * Returns whether the currently running application was built with the Manifest's "debuggable"
     * attribute set to true (which means it has been exported and signed with a certificate).
     *
    ...
    /**
     * Returns the AndroidManifest application version from the {@link PackageInfo}
     */
    ...
    /**
     * Returns the AndroidManifest application version code from the {@link PackageInfo}
     */
    ...
    /**
     * Returns the maximum available application heap size, in bytes. This is useful to set the max
     * size of memory caches within the application.
     */
    ...
    /**
     * Increments the application activity stack by one. Call this in the activity {@link
     * Activity#onResume()}
     *
    ...
    /**
     * Decrements the application activity stack by one. Call this in the activity {@link
     * Activity#onPause()}
     *
     * @return The current (approximated) activity stack count
     */
    ...
    /**
     * Enumerate the currently supported {@link StrictMode}s that can be enabled from within this
     * class.
     */
    public enum DroidStrictMode {
        /**
         * No strict mode enabled (Android default). Sets policies to {@link ThreadPolicy#LAX} and
         * {@link VmPolicy#LAX}.
         */
        NONE,
        /**
    ...
    /**
     * Sets the {@link StrictMode} reporting functionalities by specifying the level of penalties
     * and logging. This method is useful to temporarily enable certain features for a specific
     * activity or other components.
     *
     ...
     * </pre>
     *
     * @param mode The {@link DroidStrictMode} to enable
     */
    @TargetApi(9)
    ...
    /**
     * Returns the default {@link StrictMode.ThreadPolicy} to be used when {@link DroidConfig#DEBUG}
     * is active. This policy only logs violations to the LogCat console.
     *
     * Override this method to provide a custom policy for {@link DroidStrictMode#DEBUG}.
     *
    ...
    /**
     * Returns the stricter {@link StrictMode.ThreadPolicy} to be used when {@link
     * DroidConfig#STRICT_MODE} is active. This policy logs violations to the LogCat console and
     * flashing the screen (API >= 11).
     *
     * Override this method to provide a custom policy for {@link DroidStrictMode#STRICT}.
     *
     * <b>Always call this from the UI thread.</b>
     */
    @NonNull
    ...
    /**
     * Returns the default {@link StrictMode.VmPolicy} to be used when {@link DroidConfig#DEBUG} is
     * active. This policy only logs violations to the LogCat console.
     *
     * Override this method to provide a custom policy for {@link DroidStrictMode#DEBUG}.
     */
    @NonNull
    ...
    /**
     * Returns the stricter {@link StrictMode.VmPolicy} to be used when {@link
     * DroidConfig#STRICT_MODE} is active. This policy only logs violations to the LogCat console.
     *
     * Override this method to provide a custom policy for {@link DroidStrictMode#STRICT}.
     */
    @NonNull
