...
public class LogUtils {
     ...
     *
     * @param logLevel   The log level to use: must be one of the level constants provided by the
     *                   {@link Log} class.
     * @param logTag
     * @param logMessage
     */
    ...
    /**
     * Prints on LogCat a stack track of an exception, only if library debugging is active.
     *
    ...
    /**
     * Prints on LogCat a log warning message with the exception stack, only if library debugging is
     * active.
     *
     * @param logTag
     * @param logMessage
    ...
    /**
     * Prints on LogCat a log warning message with the exception's message string, only if library
     * debugging is active.
     *
     * @param t The {@link Throwable} to get the message from
     */
