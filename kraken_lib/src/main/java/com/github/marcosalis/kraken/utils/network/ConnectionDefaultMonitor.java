 ...
 * Useful to easily retrieve the device's current connection status without
 * querying the {@link ConnectivityManager}.
 * 
...
public enum ConnectionDefaultMonitor implements ConnectionMonitor {
	...
	/**
	 * Shortcut method to return the {@link ConnectionDefaultMonitor} singleton
	 * instance.
	 */
	...
	/**
	 * Initializes the {@link ConnectionDefaultMonitor}. It registers a
