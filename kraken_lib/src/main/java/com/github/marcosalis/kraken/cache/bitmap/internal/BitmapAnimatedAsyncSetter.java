...
/**
 * Extension of {@link BitmapAsyncSetter} that starts a fade-in animation right after setting the
 * image bitmap when this is loaded from the disk or network.
 *
 * @author Marco Salis
 * @since 1.0
 */
...
public class BitmapAnimatedAsyncSetter extends BitmapAsyncSetter {
     ...
     * @param mode              The {@link AnimationMode} to use
     * @param customAnimationId The ID of a custom animation to load, or -1 to use the default
     *                          Android fade-in animation.
     * @see BitmapAsyncSetter#BitmapAsyncSetter(ImageView, BitmapAsyncSetter#OnBitmapImageSetListener)
     */
    public BitmapAnimatedAsyncSetter(@NonNull CacheUrlKey key, @NonNull ImageView imgView,
     ...
     * @param source    The {@link CacheSource} from where the bitmap was loaded
     */
    ...
    /**
     * Returns whether the bitmap setting should be animate depending on the current {@link
     * CacheSource} and {@link AnimationMode}.
     */
