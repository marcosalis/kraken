 ...
 * See the {@link NetworkReceiver} documentation instead.
 * 
 * @since 1.0
 * @author Marco Salis
 */
...
class NetworkBroadcastReceiver extends BroadcastReceiver {
	...
	/**
	 * Simple extension of the Intent class used by NetworkReceiver and client
	 * classes to handle intents about a network connection change notification.
	 */
	static class NetworkIntent extends Intent {
		 ...
		 * 
		 * @param type
		 *            The type of an active network connection
		 */
		...
		/**
		 * Get the intent's connection type, if set. Can be one of those listed
		 * in {@link ConnectionManager} or -1 if not set
		 */
		int getNetworkType() {
