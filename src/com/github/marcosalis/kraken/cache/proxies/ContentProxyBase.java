...
public abstract class ContentProxyBase implements ContentProxy {
	...
	/**
	 * Low priority, single thread executor to be used for network requests or
	 * other tasks that don't immediately affect the user experience and
	...
	/**
	 * Executes a non time-critical {@link Runnable} task using the common low
	 ...
	 * proxies common pre-fetch thread pool.
	 * 
	 * @param runnable
	 *            The {@link Runnable} to execute (must be non null)
	 */
	...
	/**
	 * Remove all not-running tasks from all static executors. Note that this
	 * method doesn't cancel tasks that are already in execution nor terminates
	 * the executors.
	 */
